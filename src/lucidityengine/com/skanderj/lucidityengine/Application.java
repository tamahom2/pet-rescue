...
public abstract class Application {
	 ...
	 *                               exists
	 */
	public Application(final String identifier, final double targetUpdatesPerSecond, final double targetFramesPerSecond, final Class<? extends Keyboard> localizedKeyboardClass) {
	...
	protected final void start() {
		...
		Logger.log(Logger.class, LogLevel.INFO, System.getProperty("user.dir"));
	}
