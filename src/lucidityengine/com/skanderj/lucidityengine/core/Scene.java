...
public abstract class Scene extends ApplicationObject {
	...
	private Action afterInTransition, afterOutTransition;
	...
	public Scene(final Application application) {
		super(application);
		this.sceneObjectsIdentifiers = new HashSet<>();
	...
	public Action afterInTransition() {
		return this.afterInTransition;
	}

	public Action afterOutTransition() {
		return this.afterOutTransition;
	}
	 ...
	 */
	public void setOutTransition(final Transition out) {
		this.outTransition = out;
	}

	public void setAfterInTransition(Action afterInTransition) {
		this.afterInTransition = afterInTransition;
	}

	public void setAfterOutTransition(Action afterOutTransition) {
		this.afterOutTransition = afterOutTransition;
	}
