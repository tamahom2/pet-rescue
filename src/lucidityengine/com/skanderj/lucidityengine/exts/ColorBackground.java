...
public class ColorBackground extends Background {
	...
	public ColorBackground(final Application application, final double x, final double y, final int width, final int height, final Color color) {
		super(application);
		this.x = x;
		this.y = y;
		this.width = width;
	...
	public synchronized void render() {
		this.application.screen().drawRectangle((int) this.x, (int) this.y, this.width, this.height, this.color, 0, 0, true);
	}
