...
public class FadeInTransition extends Transition {
	...
	public void render() {
		if (!this.isDone) {
			...
			this.application.screen().drawRectangle(0, 0, this.application.window().getConfiguration().getWidth(), this.application.window().getConfiguration().getHeight(), newColor, 0, 0, true);
		}
	}
