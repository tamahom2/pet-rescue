...
public final class OnScreenText {
	 ...
	 * Self explanatory.
	 */
	public final void draw(final Screen screen, final int x0, final int y0, final int width, final int height, final Object... args) {
	 ...
	 * Self explanatory.
	 */
	private static final void drawString(final Screen screen, final int x0, final int y0, final OnScreenText string, final Object... args) {
		final OnScreenText formatted = new OnScreenText(args.length > 0 ? String.format(string.content, args) : string.content, new OnScreenTextProperties(string.font, string.color, string.shadeColor, string.position));
	 ...
	 * Self explanatory.
	 */
	private static final void drawCenteredString(final Screen screen, final int x0, final int y0, final int width, final int height, final OnScreenText string, final Object... args) {
		final OnScreenText formatted = new OnScreenText(args.length > 0 ? String.format(string.content, args) : string.content, new OnScreenTextProperties(string.font, string.color, string.shadeColor, string.position));
	 ...
	 * Self explanatory.
	 */
	private static final int drawCenteredStringWidthless(final Screen screen, final int x0, final int y0, final int height, final OnScreenText string, final Object... args) {
		final OnScreenText formatted = new OnScreenText(args.length > 0 ? String.format(string.content, args) : string.content, new OnScreenTextProperties(string.font, string.color, string.shadeColor, string.position));
		screen.setFont(formatted.font);
		screen.setColor(formatted.color);
		final FontMetrics fontMetrics = screen.getFontMetrics();
	 ...
	 * Self explanatory.
	 */
	private static final int drawCenteredStringAbsolute(final Screen screen, final int x0, final int y0, final int height, final OnScreenText string, final Object... args) {
		final OnScreenText formatted = new OnScreenText(args.length > 0 ? String.format(string.content, args) : string.content, new OnScreenTextProperties(string.font, string.color, string.shadeColor, string.position));
		screen.setFont(formatted.font);
		screen.setColor(formatted.color);
