...
public final class OnScreenTextProperties {
	...
	public OnScreenTextProperties(final Font font, final Color color, final Color shadeColor, final OnScreenTextPosition onScreenTextPosition) {
		this.font = font;
		this.color = color;
	...
	public OnScreenTextProperties build(final int fontSize) {
		return new OnScreenTextProperties(this.font.deriveFont((float) fontSize), this.color, this.shadeColor, this.position);
	}

	public enum OnScreenTextPosition {
