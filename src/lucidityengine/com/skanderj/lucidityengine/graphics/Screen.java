...
public final class Screen {
	...
	protected Screen(final Canvas canvas, final WindowConfiguration windowConfiguration) {
		...
		this.imageOnScreen = new BufferedImage(windowConfiguration.width, windowConfiguration.height, BufferedImage.TYPE_INT_ARGB);
	...
	public void pop() {
		...
		this.canvasGraphics.drawImage(this.imageOnScreen, 0, 0, this.imageOnScreen.getWidth(), this.imageOnScreen.getHeight(), null);
	 ...
	 * @param fill
	 */
	public void drawRectangle(final int x, final int y, final int width, final int height, final Color color, final int arcWidth, final int arcHeight, final boolean fill) {
		this.imageGraphics.setColor(color);
		if (fill) {
	 ...
	 * @param height
	 */
	public void drawImage(final BufferedImage bufferedImage, final int x, final int y, final int width, final int height) {
	 ...
	 * @param args
	 */
	public final void drawText(final OnScreenText text, final int x0, final int y0, final int width, final int height, final Object... args) {
