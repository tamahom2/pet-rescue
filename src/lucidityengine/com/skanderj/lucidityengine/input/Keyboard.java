...
import com.skanderj.lucidityengine.input.localized.AZERTYKeyboardWindows;
...
public abstract class Keyboard extends KeyAdapter implements InputDevice {
	...
	public static final Class<AZERTYKeyboardWindows> AZERTY = AZERTYKeyboardWindows.class;
	 ...
	 * pretty complete.
	 */
	public abstract String getKeyRepresentation(final int keycode, final boolean shiftDown, final boolean capsLocked, final boolean altGrDown);
