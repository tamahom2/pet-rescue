...
public final class Logger {
	...
	public static void redirectSystemOutput() {
		if (Logger.outputRedirected) {
			...
			Logger.log(Engine.class, LogLevel.INFO, "Lucidity Engine release %s - running on %s", Engine.RELEASE, System.getProperty("os.name"));
	...
	public static void toggleDebugging(final DebuggingType type, final boolean status) {
		...
		case CLASSIC:
			Logger.debug = status;
			Logger.log(Logger.class, LogLevel.INFO, "%s non-development debug messages", status ? "Enabled" : "Disabled");
			break;
		case DEVELOPMENT:
