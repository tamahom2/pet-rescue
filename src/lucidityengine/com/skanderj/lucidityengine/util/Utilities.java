...
public final class Utilities {
	public static final String NULL = null, EMPTY = new StringBuilder("").toString(), SPACE = new StringBuilder(" ").toString();
	...
	public static String getCWD() throws Exception {
		return Utilities.readProcessOutput(new String[] { "pwd" });
	}
