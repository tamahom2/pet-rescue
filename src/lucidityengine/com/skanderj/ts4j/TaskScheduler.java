...
public final class TaskScheduler {
	...
	public static boolean scheduleTask(final String identifier, final Task task) {
		for (final String futureId : TaskScheduler.scheduledFutures.keySet().toArray(new String[TaskScheduler.scheduledFutures.size()])) {
			if (TaskScheduler.scheduledFutures.get(futureId).isDone() || TaskScheduler.scheduledFutures.get(futureId).isCancelled()) {
	...
	public static Task retrieveTask(final String identifier) {
